...
class W_CALC(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "W_CALC", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("W_CALC")
        ...
        self.settings = Qt.QSettings("GNU Radio", "W_CALC")
        ...
        # Blocks
        ##################################################
        self._amplitud_range = Range(0, 100, 1, 10, 200)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 1000, amplitud, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0_0, 0), (self.CalculoPotenciaComunicaciones_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.qtgui_freq_sink_x_0, 0))
...
def main(top_block_cls=W_CALC, options=None):
